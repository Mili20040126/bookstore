        ...
        <div class="row">
            <div class="col-12">
                <form action="actionUsuario.php?pagina=formUsuario" method="POST" class="was-validated" enctype="multipart/form-data">
                    ...
                    <div class="form-floating mb-3 mt-3">
                        <input type="date" class="form-control" id="dataNascUsuario" placeholder="Data de Nascimento" name="dataNascUsuario" required>
                    ...
                    <div class="form-floating mb-3 mt-3">
                        <input type="text" class="form-select" id="cidadeUsuario" name="cidadeUsuario" required>
                        <label for="cidadeUsuario">Cidade</label>
                        <div class="valid-feedback"></div>
                        <div class="invalid-feedback"></div>
                    </div>
                    <div class="form-floating mb-3 mt-3">
                        <input type="text" class="form-select" id="ufUsuario" name="ufUsuario" required>
