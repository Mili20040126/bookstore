...
<?php
    ...
    if($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        $fotoUsuario = $nomeUsuario = $dataNascUsuario = $cidadeUsuario = $telefoneUsuario =
        ...
        if(empty($_POST["dataNascUsuario"])){
            ...
            //Armazena o valor na variável
            $dataNascUsuario = testar_entrada($_POST["dataNascUsuario"]);
            ...
            if(strlen($dataNascUsuario) == 10){
                ...
                $dia = substr($dataNascUsuario, 8, 2);
                $mes = substr($dataNascUsuario, 5, 2);
                $ano = substr($dataNascUsuario, 0, 4);
        ...
        if(!$erroPreenchimento && !$erroUpload){
            ...
            $inserirUsuario = "INSERT INTO usuarios (tipoUsuario, fotoUsuario, nomeUsuario, dataNascUsuario, cidadeUsuario, telefoneUsuario, emailUsuario, senhaUsuario)
                                VALUES ('cliente', '$fotoUsuario', '$nomeUsuario', '$dataNascUsuario', '$cidadeUsuario', '$telefoneUsuario', '$emailUsuario', '$senhaUsuario') ";
